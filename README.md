...
Above is the circuit diagram of the PV module itself which is used to carry out the simulation on a DC voltage sweep. Below are the V-I Characteristics generated from the simulation.
